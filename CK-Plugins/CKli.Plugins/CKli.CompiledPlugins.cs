// <auto-generated>
// This file was generated by CKli v0.0.8--0146-dev.
...
[GeneratedCode("CKli", "0.0.8--0146-dev")]
public static class CompiledPlugins
{
    ...
    public static IPluginFactory UncheckedGet()
    {
        ...
        var pluginCommands = new PluginCommand[]{
            new Cmd_release_database＿rebuild( infos[1].PluginTypes[0] ),
       ...
       cmds.Add( "release-database", null );
       cmds.Add( "fix", null );
       cmds.Add( "repo", null );
...
[GeneratedCode("CKli", "0.0.8--0146-dev")]
sealed class Cmd_release_database＿rebuild : PluginCommand
{
    internal Cmd_release_database＿rebuild( IPluginTypeInfo typeInfo )
        : base( typeInfo,
                "release-database rebuild",
