// <auto-generated>
// This file was generated by CKli v0.0.0-0.
...
public static class CompiledPlugins
{
    ...
    public static IPluginFactory UncheckedGet()
    {
        var infos = new PluginInfo[]{
            ...
            new PluginInfo( "CKli.ShallowSolution.Plugin", "ShallowSolution", (PluginStatus)0, "0.0.8--0234-dev/11c43de488613b880b2e29e7ba356296ae7924b1/2026-04-13 11:39:53Z", new IPluginTypeInfo[1] ),
...
sealed class Generated : IPluginFactory
{
    ...
    public PluginCollection Create( IActivityMonitor monitor, World world )
    {
        ...
        objects[7] = new CKli.Net8Migration.Plugin.Net8MigrationPlugin( new PrimaryPluginContext( _plugins[5], configs, world ), (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[0], (CKli.VersionTag.Plugin.VersionTagPlugin)objects[2], (CKli.BranchModel.Plugin.BranchModelPlugin)objects[4], (CKli.Build.Plugin.BuildPlugin)objects[6] );
        ...
        objects[9] = new CKli.Publish.Plugin.PublishPlugin( new PrimaryPluginContext( _plugins[8], configs, world ), (CKli.Build.Plugin.BuildPlugin)objects[6], (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[0], (CKli.ReleaseDatabase.Plugin.ReleaseDatabasePlugin)objects[1], (CKli.VersionTag.Plugin.VersionTagPlugin)objects[2] );
