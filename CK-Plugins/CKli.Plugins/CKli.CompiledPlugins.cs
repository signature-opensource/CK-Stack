// <auto-generated>
// This file was generated by CKli v0.0.8--0166-dev.
...
[GeneratedCode("CKli", "0.0.8--0166-dev")]
public static class CompiledPlugins
{
    static ReadOnlySpan<byte> _configSignature => [204,63,114,215,56,47,210,64,147,125,90,74,230,157,2,167,31,74,232,187];
    ...
    public static IPluginFactory UncheckedGet()
    {
        var infos = new PluginInfo[]{
            ...
            new PluginInfo( "CKli.VSSolution.Plugin", "VSSolution", (PluginStatus)0, "0.0.8--0166-dev/57fb8993a696c7eb101adaed3f52676d8c3eb9aa/2026-01-22 17:36:19Z", new IPluginTypeInfo[1] ),
        };
        PluginInfo plugin;
        ...
        plugin = infos[6];
        types = (IPluginTypeInfo[])plugin.PluginTypes;
        types[0] = new PluginTypeInfo( plugin, "CKli.VSSolution.Plugin.VSSolutionPlugin", true, 0, 5 );
...
sealed class Generated : IPluginFactory
{
    ...
    public PluginCollection Create( IActivityMonitor monitor, World world )
    {
        ...
        objects[5] = new CKli.VSSolution.Plugin.VSSolutionPlugin( new PrimaryPluginContext( _plugins[6], configs, world ) );
        objects[6] = new CKli.Build.Plugin.BuildPlugin( new PrimaryPluginContext( _plugins[2], configs, world ), (CKli.VersionTag.Plugin.VersionTagPlugin)objects[2], (CKli.BranchModel.Plugin.BranchModelPlugin)objects[3], (CKli.Build.Plugin.RepositoryBuilderPlugin)objects[4], (CKli.ReleaseDatabase.Plugin.ReleaseDatabasePlugin)objects[1], (CKli.ArtifactHandler.Plugin.ArtifactHandlerPlugin)objects[0], (CKli.VSSolution.Plugin.VSSolutionPlugin)objects[5] );
        objects[7] = new CKli.Net8Migration.Plugin.Net8MigrationPlugin( new PrimaryPluginContext( _plugins[5], configs, world ), (CKli.VersionTag.Plugin.VersionTagPlugin)objects[2], (CKli.Build.Plugin.BuildPlugin)objects[6] );
...
sealed class Cmd_fix＿build : PluginCommand
{
    internal Cmd_fix＿build( IPluginTypeInfo typeInfo )
        : base( typeInfo,
                ...
                "FixBuild", MethodAsyncReturn.None ) {}
    protected override ValueTask<bool> HandleCommandAsync( IActivityMonitor monitor, CKliEnv context, CommandLineArguments cmdLine )
    {
        var f0 = cmdLine.EatFlag( Flags[0].Names );
        var f1 = cmdLine.EatFlag( Flags[1].Names );
        if( !cmdLine.Close( monitor ) ) return ValueTask.FromResult( false );
        return ValueTask.FromResult( ((CKli.Build.Plugin.BuildPlugin)Instance).FixBuild(
                                           monitor, context, f0, f1 ) );
    }
}
[GeneratedCode("CKli", "0.0.8--0166-dev")]
